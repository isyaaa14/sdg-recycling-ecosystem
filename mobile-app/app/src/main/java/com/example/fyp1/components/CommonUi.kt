...
@Composable
fun HomeStepItem(title: String, desc: String, icon: ImageVector, color: Color, onClick: () -> Unit) {
    Card(modifier = Modifier.fillMaxWidth().padding(bottom = 12.dp).clickable { onClick() }) {
...
@Composable
fun ProfileMenuRow(label: String, icon: ImageVector, color: Color = Color.Black, onClick: () -> Unit) {
